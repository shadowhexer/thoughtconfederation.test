...
(function(a)
{
    "use strict";return function()
    {
        ...
        function c(a,b,c)
        {
            return b=m(b),b in a?Object.defineProperty(a,b,
            {
        ...
        function k(a,b)
        {
            ...
            {
                var d=b[c];
                d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,m(d.key),d)
            }
        }
                
        function l(a,b,c)
        {
            return b&&k(a.prototype,b),c&&k(a,c),Object.defineProperty(a,"prototype",{writable:!1}),a
        }
        ...
        for(var o=[["Afghanistan","af","93"],
                   ...
                   {
                    var q=o[p];
                    o[p]={name:q[0],iso2:q[1],dialCode:q[2],priority:q[3]||0,areaCodes:q[4]||null,nodeById:{}}
                }
                ...
                var r=
                {
                    ...
                    instances:{},documentReady:function(){return"complete"===document.readyState}
                };
                "object"==typeof window&&(window.intlTelInputGlobals=r);

                // Customise functions by altering conditions or adding new functions
                var s=0, 
                t={allowDropdown:!0,autoInsertDialCode:!1,autoPlaceholder:"polite",countrySearch:!0,containerClass:"",customPlaceholder:null,dropdownContainer:null,excludeCountries:[],fixDropdownWidth:!0,formatAsYouType:!0,formatOnDisplay:!0,geoIpLookup:null,hiddenInput:null,i18n:{},initialCountry:"",nationalMode:!0,onlyCountries:[],placeholderNumberType:"MOBILE",preferredCountries:[],showFlags:!0,showSelectedDialCode:!1,useFullscreenPopup:"undefined"!=typeof navigator&&"undefined"!=typeof window&&(/Android.+Mobile|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||window.innerWidth<=500),utilsScript:""},
                u=["800","822","833","844","855","866","877","880","881","882","883","884","885","886","887","888","889"],
                v=function(a)
                {
                    var b=window.intlTelInputGlobals.instances;Object.values(b).forEach(function(b)
                    {
                        return b[a]()
                    })
                },
                w=function()
                {
                    function c(b)
                    {
                        var d=arguments.length>1&&arguments[1]!==a?arguments[1]:{};
                        j(this,c),this.id=s++,this.a=b,this.b=null,this.c=null,this.d=Object.assign({},t,d),this.e=Boolean(b.getAttribute("placeholder"))
                    }
                    return l(c,[
                        {
                            key:"_init",value:function()
                            {
                                var a=this;this.d.useFullscreenPopup&&(this.d.fixDropdownWidth=!1),this.d.countrySearch&&!this.d.useFullscreenPopup&&(this.d.fixDropdownWidth=!0),this.d.nationalMode&&(this.d.autoInsertDialCode=!1),this.d.showSelectedDialCode&&(this.d.autoInsertDialCode=!1);
                                ...
                                {
                                    var c=new Promise(function(b,c){a.h=b,a.i=c}), d=new Promise(function(b,c){a.i0=b,a.i1=c});
                            
                                    this.promise=Promise.all([c,d])
                                }
                                else this.h=this.i=function(){},this.i0=this.i1=function(){};this.s={},this._b(),this._f(),this._h(),this._i(),this._i3()
                            }
                        },
                        {
                            key:"_b",value:function(){this._d(),this._d2(),this._e(),this._d0(),(this.d.onlyCountries.length||this.d.i18n)&&this.p.sort(this._d1)}
                        },
                        {
                        ...
                        },
                        {
                            key:"_d",value:function()
                            {
                                if(this.d.onlyCountries.length)
                                {
                                    ...
                                    this.p=o.filter(function(b){return a.indexOf(b.iso2)>-1})
                                }
                                else if(this.d.excludeCountries.length)
                                {
                                    var b=this.d.excludeCountries.map(function(a){return a.toLowerCase()});

                                    this.p=o.filter(function(a){return-1===b.indexOf(a.iso2)})
                                }
                                else this.p=o
                            }
                        },
                        ...
                        },
                        {
                            key:"_f",value:function()
                            {
                                ...
                                var a=this.d,c=a.allowDropdown,d=a.showSelectedDialCode,e=a.showFlags,f=a.containerClass,g=a.hiddenInput,h=a.dropdownContainer,i=a.fixDropdownWidth,j=a.useFullscreenPopup,k=a.countrySearch,l="iti";
                        
                                c&&(l+=" iti--allow-dropdown"),d&&(l+=" iti--show-selected-dial-code"),e&&(l+=" iti--show-flags"),f&&(l+=" ".concat(f)),j||(l+=" iti--inline-dropdown");
                                ...
                                if(g)
                                {
                                    var q=this.a.getAttribute("name"),r=g(q);
                            
                                    this.hiddenInput=this._e2("input",{type:"hidden",name:r}),m.appendChild(this.hiddenInput)
                                }
                            }
                        },
                        {
                            key:"_g",value:function(a,b,c)
                            {
                                ...
                                {
                                    var e=a[d],f=c?"-preferred":"",g=this._e2("li",{id:"iti-".concat(this.id,"__item-").concat(e.iso2).concat(f),"class":"iti__country ".concat(b),tabindex:"-1",role:"option","data-dial-code":e.dialCode,"data-country-code":e.iso2,"aria-selected":"false"},this.countryList);e.nodeById[this.id]=g;var h="";
                        ...
                        },
                        {
                            ...
                            value:function()
                            {
                                var a=this.a.getAttribute("value"),b=this.a.value,c=a&&"+"===a.charAt(0)&&(!b||"+"!==b.charAt(0)),d=c?a:b,e=this._5(d),f=this._w(d),g=this.d,h=g.initialCountry,i=g.autoInsertDialCode;
                        
                                if(e&&!f) this._v(d);
                                else if("auto"!==h)
                                {
                                    var j=h&&this._y(h,!1,!0);
                                    j?this._z(h.toLowerCase()):e&&f?this._z("us"):(this.j=this.preferredCountries.length?this.preferredCountries[0].iso2:this.p[0].iso2,d||this._z(this.j)),!d&&i&&(this.a.value="+".concat(this.s.dialCode))
                                }
                                d&&this._u(d)
                            }
                        },
                        ...
                        },
                        {
                            ...
                            {
                                var a=this;this._a9=function(b)
                                {
                        ...
                        },
                        {
                            ...
                            value:function()
                            {
                                ...
                                this._a12=function(c)
                                {
                                    ...
                                    {
                                        var d=a.a.selectionStart,e=a.a.value.substring(0,d),f=e.replace(/[^+0-9]/g,"").length,g=c&&"deleteContentForward"===c.inputType,h=a._formatNumberAsYouType(),i=a._translateCursorPosition(f,h,d,g);a.a.value=h,a.a.setSelectionRange(i,i)
                                    }
                                },
                                this.a.addEventListener("input",this._a12),this._a13=function(){setTimeout(a._a12)},this.a.addEventListener("cut",this._a13),this.a.addEventListener("paste",this._a13)
                            }
                        },
                        {
                            ...
                            key:"_m2",value:function(a)
                    {
                        ...
                        {
                            key:"_n2",
                            value:function(a,b,c){c&&!a.classList.contains(b)?a.classList.add(b):!c&&a.classList.contains(b)&&a.classList.remove(b)}
                        },
                        {
                            key:"_o",
                            value:function()
                            {
                                ...
                                {
                                    var b=this.a.getBoundingClientRect(),c=document.documentElement.scrollTop,d=b.top+c,e=this.dropdownContent.offsetHeight,f=d+this.a.offsetHeight+e<c+window.innerHeight,g=d-e>c,h=!this.d.countrySearch&&!f&&g;

                                    if(this._n2(this.dropdownContent,"iti__dropdown-content--dropup",h),this.d.dropdownContainer)
                                    {
                                        var i=h?0:this.a.offsetHeight;this.dropdown.style.top="".concat(d+i,"px"),this.dropdown.style.left="".concat(b.left+document.body.scrollLeft,"px"),this._a4=function(){return a._2()},window.addEventListener("scroll",this._a4)
                                    }
                                }
                            }
                        },
                        {
                            ...
                            {
                                var a=this;
                                this._a0=function(b){var c=b.target.closest(".iti__country");c&&a._x(c,!1)},this.countryList.addEventListener("mouseover",this._a0),this._a1=function(b){var c=b.target.closest(".iti__country");c&&a._1(c)},this.countryList.addEventListener("click",this._a1);
                                    
                                var b=!0;
                                this._a2=function(){b||a._2(),b=!1},document.documentElement.addEventListener("click",this._a2);
                                    
                                var c="",d=null;
                                if(this._a3=function(b){["ArrowUp","ArrowDown","Enter","Escape"].includes(b.key)&&(b.preventDefault(),b.stopPropagation(),"ArrowUp"===b.key||"ArrowDown"===b.key?a._q(b.key):"Enter"===b.key?a._r():"Escape"===b.key&&a._2()),!a.d.countrySearch&&/^[a-zA-ZÀ-ÿа-яА-Я ]$/.test(b.key)&&(b.stopPropagation(),d&&clearTimeout(d),c+=b.key.toLowerCase(),a._s(c),d=setTimeout(function(){c=""},1e3))},document.addEventListener("keydown",this._a3),this.d.countrySearch)
                                {
                                    var e=function()
                                    {
                                    ...
                                    this._handleSearchChange=function(){f&&clearTimeout(f),f=setTimeout(function(){e(),f=null},100)},this.searchInput.addEventListener("input",this._handleSearchChange),this.searchInput.addEventListener("click",function(a)
                                    {
                        ...
                        },
                        {
                            ...
                            {
                                return(arguments.length>0&&arguments[0]!==a?arguments[0]:"").normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase()
                            }
                        },
                        {
                            key:"_filterCountries",value:function(b)
                            {
                                var c=arguments.length>1&&arguments[1]!==a&&arguments[1],d=!0;this.countryList.innerHTML="";
                                for(var e=this._normaliseString(b),f=0;f<this.p.length;f++)
                                {
                                    var g=this.p[f],h=this._normaliseString(g.name),i="+".concat(g.dialCode);(c||h.includes(e)||i.includes(e)||g.iso2.includes(e))&&(this.countryList.appendChild(g.nodeById[this.id]),d&&(this._x(g.nodeById[this.id],!1),d=!1))
                                }
                            }
                        },
                        {
                            ...
                            {
                                var b="ArrowUp"===a?this.c.previousElementSibling:this.c.nextElementSibling;if(b?b.classList.contains("iti__divider")&&(b="ArrowUp"===a?b.previousElementSibling:b.nextElementSibling):this.countryList.childElementCount>1&&(b="ArrowUp"===a?this.countryList.lastElementChild:this.countryList.firstElementChild),b)
                                {
                                    var c=!this.d.countrySearch;this._x(b,c),this.d.countrySearch&&this._3(b,!1)
                                }
                            }
                        },
                        {
                            key:"_r",value:function(){this.c&&this._1(this.c)}},{key:"_s",value:function(a)
                            {
                        ...
                        },
                        {
                            ...
                            value:function(a)
                            {
                                ...
                                {
                                    var c=this.d.nationalMode||"+"!==b.charAt(0)&&!this.d.showSelectedDialCode,d=intlTelInputUtils.numberFormat,e=d.NATIONAL,f=d.INTERNATIONAL,g=c?e:f;b=intlTelInputUtils.formatNumber(b,this.s.iso2,g)
                                }
                        ...
                        },
                        {
                            ...
                            value:function(a)
                            {
                                var b=a.indexOf("+"),c=b?a.substring(b):a,d=this.s.dialCode,e="1"===d;
                                c&&e&&"+"!==c.charAt(0)&&("1"!==c.charAt(0)&&(c="1".concat(c)),c="+".concat(c)),this.d.showSelectedDialCode&&d&&"+"!==c.charAt(0)&&(c="+".concat(d).concat(c));
                                
                                var f=this._5(c,!0),g=this._m(c),h=null;
                                if(f)
                                {
                                    var i=this.q[this._m(f)],j=-1!==i.indexOf(this.s.iso2)&&g.length<=f.length-1;if(!("1"===d&&this._w(g))&&!j)
                                ...
                                "+"===c.charAt(0)&&g.length?h="":c&&"+"!==c||(h=this.j);
                        ...
                        },
                        {
                            ...
                            value:function(a)
                            {
                                var b=this.d,c=b.allowDropdown,d=b.showSelectedDialCode,e=b.showFlags,f=b.countrySearch,g=this.s.iso2?this.s:{};
                                ...
                                if(this.s=a?this._y(a,!1,!1):{},this.s.iso2&&(this.j=this.s.iso2),e&&this.l.setAttribute("class","iti__flag iti__".concat(a)),this._setSelectedCountryFlagTitleAttribute(a,d),d)
                                {
                                    ...
                                    this.t.innerHTML=h;
                                    var i=this.selectedFlag.offsetWidth||this._z2();this.isRTL?this.a.style.paddingRight="".concat(i+6,"px"):this.a.style.paddingLeft="".concat(i+6,"px")
                                }
                                if(this._0(),c&&!f)
                                {
                                    var j=this.b;
                                    if(j&&(j.classList.remove("iti__active"),j.setAttribute("aria-selected","false")),a)
                                    {
                                        var k=this.countryList.querySelector("#iti-".concat(this.id,"__item-").concat(a,"-preferred"))||this.countryList.querySelector("#iti-".concat(this.id,"__item-").concat(a));k.setAttribute("aria-selected","true"),k.classList.add("iti__active"),this.b=k
                                    }
                                }
                                return g.iso2!==a
                            }
                        },
                        {
                            ...
                            value:function(a,b)
                            {
                                ...
                                {
                                    var c;c=a&&!b?"".concat(this.s.name,": +").concat(this.s.dialCode):a?this.s.name:"Unknown",this.selectedFlag.setAttribute("title",c)
                                }
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            {
                                var c=this.countryList,d=document.documentElement.scrollTop,e=c.offsetHeight,f=c.getBoundingClientRect().top+d,g=f+e,h=a.offsetHeight,i=a.getBoundingClientRect().top+d,j=i+h,k=i-f+c.scrollTop,l=e/2-h/2;
                        ...
                        },
                        {
                            ...
                            {
                                var b=a;if(this.d.showSelectedDialCode)
                                {
                                    var c=this._5(b);
                                    if(c)
                                    {
                        ...
                        },
                        {
                            ...
                            {
                                var a=this._6(),b=window.intlTelInputUtils?intlTelInputUtils.formatNumberAsYouType(a,this.s.iso2):a,c=this.s.dialCode;
                ...
                var x=function(a,b,c)
                {
                    ...
                    d.onload=function()
                    {
                        v("handleUtils"),b&&b()},d.onerror=function()
                        {
                            v("rejectUtilsScriptPromise"),c&&c()
                        },
                        d.className="iti-load-utils",d.async=!0,d.src=a,document.body.appendChild(d)
                    };
                    return r.loadUtils=function(a)
                    {
                        if(!window.intlTelInputUtils&&!window.intlTelInputGlobals.startedLoadingUtilsScript)
                        {
                            if(window.intlTelInputGlobals.startedLoadingUtilsScript=!0,"undefined"!=typeof Promise)
                            return new Promise(function(b,c){return x(a,b,c)});
                            x(a)
                        }
                        return null
                    },
                    r.defaults=t,r.version="19.2.16",function(a,b)
                    {
                        var c=new w(a,b);
